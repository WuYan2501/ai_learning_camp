...
> 这一节可以理解成从“传统机器学习”走向“神经网络世界”的桥。后面你看到的 Transformer、RAG、Agent，很多底层训练直觉都要从这里接上。
>
> **如果你只想先抓大模型最相关的内容，优先看：激活函数、归一化、训练技巧。**

- **激活函数** ⭐
  - *先知道什么*：网络为什么不能只是线性堆叠，以及非线性到底带来了什么
...
- **反向传播与计算图**
  - *先知道什么*：模型到底是怎样把“错误”一层层传回去改参数的
  - *核心思想*：前向传播建图，反向传播沿图求梯度（链式法则）
  - *面试高频*：手推一个简单网络的反向传播

- **CNN 核心概念**
  - *先知道什么*：为什么视觉模型早期几乎都绕不开卷积
...
- **训练技巧**
  - *先知道什么*：训练跑不稳、loss 发散、显存不够时，通常先从这几项排查
